...
from gym_brt.control import QubeFlipUpControl, dampen_policy
...
try:
    from gym_brt.quanser.quanser_wrapper.quanser_wrapper import QubeServo2USB
except ImportError:
    print("Warning: Can not import QubeServo2USB in qube_interface.py")
...
class QubeHardware(object):
    ...
    def __init__(self, frequency=250, max_voltage=18.0):
        ...
        self.controller = QubeFlipUpControl(sample_freq=frequency)
    ...
    def reset_up(self):
        ...
        state = self.step([1.0])
        while True:
            action = self.controller.action(state)
...
class QubeHardware2(object):
    ...
    def __init__(self, frequency=250, max_voltage=18.0):
        ...
        # Open the Qube
        self.qube = QubeServo2USB(frequency=frequency)  # TODO: max_voltage=max_voltage
        self.qube.__enter__()

"""
OpenAI Gym environments with feature vector of specified Variational Auto Encoder model (data_id, model_name) as state
...
from visiontovision.vae_predictor import VAEPredictorSmall

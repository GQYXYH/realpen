...
class R_Actor(nn.Module):
    ...
    def __init__(self, args, obs_space, action_space, device=torch.device("cpu")):
        ...
        self.act_ctrl = ACTLayer(action_space, self.hidden_size, self._use_orthogonal, self._gain)
    ...
    def forward(self, obs, available_actions=None, deterministic=False):
        ...
        action_log_probs = ctrl_action_log_probs
        ...
        # print("Actions grad:", actions.requires_grad)
        actions=actions.requires_grad_()
        action_log_probs = action_log_probs.requires_grad_()
    ...
    def evaluate_actions(self, obs, action,  available_actions=None, active_masks=None):
        ...
        #                                                         active_masks if self._use_policy_active_masks
        #                                                         else None)
        action_log_probs = control_log_probs
        dist_entropy = control_dist_entropy
